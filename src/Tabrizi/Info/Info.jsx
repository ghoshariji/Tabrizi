        ...
        <div className='info'>
            <div className='container-box'>
                {box.map((item) => (
                    <div className='box' key={item.id}>
                        <FontAwesomeIcon className='point' icon={faCircle} style={{ color: item.color }} />
                        <h2>{item.title}</h2>
                        <button
                            style={{
            ...
            <div className='container-info'>
                ...
                <div className='container-text'>
                    <p>"Chez AG Sanitaire, nous offrons<br />des solutions de qualité pour vos<br />besoins en installations sanitaires,<br />chauffage et dépannage. Notre équipe<br />veille à respecter les normes et à<br />optimiser l'efficacité énergétique.<br />Faites confiance à notre expertise<br />pour un confort durable et adapté à<br />votre budget."</p>
                </div>
            </div>
        </div>
    );
