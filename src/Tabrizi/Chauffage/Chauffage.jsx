    ...
    `}
           ...
           (max-width: 767px) 130vw"
                ...
                <div className="absolute inset-0 flex flex-col lg:items-center md:items-center justify-center text-white px-4">
                  <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl  lg:text-center sm:text-[18px] md:text-[30px] lg:text-[40px] xl:text-[50px] lg:text-left lg:mt-4 xl:mt-5 lg:mr-20 md:mr-20">
                    CHAUFFAGE
                  </h1>
