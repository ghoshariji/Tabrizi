      ...
      <section id="home">
        ...
        <div className="home">
          ...
          <div className="background relative w-full h-screen flex flex-col items-center justify-center lg:items-start lg:pl-32">
            <div className="relative w-full h-1/5 sm:h-2/5 lg:h-2/5 flex items-center justify-center lg:justify-start px-4 lg:px-12">
              <img
              ...
              />
              <h1 className="absolute inset-0 flex items-center justify-center lg:justify-start text-white text-xl sm:text-3xl md:text-4xl lg:text-3xl text-center lg:text-left px-4 lg:px-8 lg:pl-10 lg:ml-32 sm:text-left sm:px-6">
                CHAUFFAGE FIABLE,
                <br />
                CONFORT ASSURÉ
              </h1>
            ...
            <div className="relative text-center lg:text-left px-4 lg:px-12 lg:mb-4 md:mb-4 lg:ml-32 mt-5 ">
